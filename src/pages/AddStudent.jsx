...
import {  Form,  Input,  Select,  Button, Card, Row, Col, notification} from 'antd';
  ...
  <Col span={8}>
    <Form.Item
      ...
      <Input placeholder="Enter roll number" />
          ...
          <Form.Item>
            <Button disabled={loading} style={{width:"100%",marginTop:"20px"}} type="primary" htmlType="submit">
              Submit
            </Button>
          </Form.Item>
        </Form>
